...
static const char *const yytname[] =
{
  ...
  "RPAREN", "EQ", "LE", "LT", "GE", "GT", "NUMBER", "ID", "$accept",
  "stmt", "expr_opt", "expr", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* stmt: WHILE LPAREN expr_opt RPAREN  */
#line 15 "while.y"
